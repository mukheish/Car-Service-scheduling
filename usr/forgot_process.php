...
$query = "SELECT * from  tms_user where u_email = '$login'"; 
$res = mysqli_query($dbc,$query);
$count=mysqli_num_rows($res);
//echo $count;
if($count==1)
{
$findresult = mysqli_query($dbc, "SELECT * from  tms_user where u_email = '$login'");
...
$FromEmail="jackstevens382@gmail.com";
...
$headers  = "MIME-Version: 1.0\n";
     ...
     $msg="Your password reset link <br> http://localhost/flone/usr/password-reset.php?token=".$token." <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>".$credits."</center>"; 
