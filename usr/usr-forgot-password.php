...
<meta charset="utf-8">
  ...
  <title>Car Service Management System | User - Forgot Password</title>
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form class="gform" id="firstFormID" method="POST"  action="https://script.google.com/macros/s/AKfycbwGPj7SdYbVWXVW9pJW1EEglV-9HgQX456SHyitDfyuw7M7GV7QtCwf4CaRtJLw5S2E/exec"> 
 ...
 <h2><em>Thanks</em> for contacting us! We will get back to you soon!
          ...
          <input onclick="showModal()" type="submit"  class="btn btn-success btn-block"><br>
        </form>
